...
export const copy = {
  en: {
    ...
    chooseRoleHeading: 'Choose your workspace',
    chooseRoleBody: 'Pick how you will use Justor. This role is locked to your account on this device and cannot be changed later.',
    chooseRoleLocked: 'Role locked',
    roleLockedToast: 'Your account is assigned to a single workspace.',
  ...
  bn: {
    ...
    signIn: 'সাইন ইন',
    signUp: 'সাইন আপ',
    signInOrSignUp: 'সাইন ইন অথবা সাইন আপ',
    chooseRoleHeading: 'আপনার ওয়ার্কস্পেস বেছে নিন',
    chooseRoleBody: 'জাস্টর কীভাবে ব্যবহার করবেন তা বেছে নিন। এই রোল এই ডিভাইসে আপনার অ্যাকাউন্টের সাথে লক থাকবে এবং পরে পরিবর্তন করা যাবে না।',
    chooseRoleLocked: 'রোল লক করা',
    roleLockedToast: 'আপনার অ্যাকাউন্ট একটি নির্দিষ্ট ওয়ার্কস্পেসে সীমাবদ্ধ।',
    signOut: 'সাইন আউট',
