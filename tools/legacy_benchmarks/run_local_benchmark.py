...
def main():
    print("=== Launching Local Backend Server for Benchmark ===")
    ...
    print("=== Running 45-Question Benchmark Harness ===")
    ...
    harness_cmd = [
        ...
        "--output", "brenchmark/benchmark_results_latest.csv",
        "--skip-ragas"
    ]
    ...
    res_file = "brenchmark/benchmark_results_latest.csv"
    if os.path.exists(res_file):
        df = pd.read_csv(res_file)
        print("\n================================================")
        print("           JUSTOR AI BENCHMARK RESULTS          ")
        print("================================================")
        total = len(df)
