...
def main():
    print("=== Launching Local Backend Server for Pilot-Launch v11 Benchmark ===")
    ...
    log_file = open("backend_benchmark_v11.log", "w", encoding="utf-8")
    ...
    print("=== Running Complete 45-Question v11 Benchmark Harness ===")

    env = os.environ.copy()
    env["JUSTOR_BACKEND_URL"] = "http://127.0.0.1:10001"

    out_file = "brenchmark/benchmark_results_pilot_launch_v11.csv"
    harness_cmd = [
        py_cmd,
    ...
    if os.path.exists(out_file):
        ...
        print("\n================================================")
        print("     JUSTOR AI PILOT-LAUNCH v11 BENCHMARK       ")
        print("================================================")
        total = len(df)
        ...
        print("------------------------------------------------")
        print(f"v11 PILOT-LAUNCH PASS RATE:  {pass_rate:.1f}% ({clean_count}/{total})")
        print("================================================\n")
